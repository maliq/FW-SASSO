...
void SASSO_train::exit_with_help()
{
	...
	"-NS n : number of path's steps selected\n"
	"-FD value : fraction for delta min, delta min = 1/FD parameter \n"
	"-MA value: 1 for active tunning support vector set before add more (default value: 0)\n"
