...
sCache::sCache(double cache_size, int num)
{
	...
	maxItem = max((int)((max(cache_size,4.0)*(1<<20))/sizeof(Qfloat)),(numData+CACHE_DELTA)*2); // cache must be large enough for two columns		
